...
| Front-end      | <div/># 관리자 페이지 <div/>#                                                                               | <div/># 마이페이지 <div/> └ (기여도 100%) <br> <div/># 친구 목록 <div/> └ (기여도 60%)                      | <div/># 지역구 상세 지도 페이지 <div/> └ (기여도 100%) <br/> # 나의 맛집 관리 페이지 <br/> └ (기여도 100%)          | <div/># 메인페이지 <div/>#위시리스트페이지                                                                  | <div/># 리뷰페이지 <div/># 나의리뷰페이지                                                                         |
| Back-end       | <div/># 프로필 사진 <div/>#                                                                                 | <div/># 마이페이지 <div/> └ (기여도 100%) <br> <div/># 친구 기능 <div/> └ (기여도 70%)                      | <div/># 맛집 ,나의 맛집 관련 CRUD <br/> └ (기여도 100%) <div/>                                                      | <div/>#퀴즈로직 <div/>#비밀호찾기 <div/> #이메일 회원인증                                                   | <div/># 리뷰페이지 <div/># 나의리뷰페이지                                                                         |
| Others         | <div/># 특별히 쓰고픈 점                                                                                    | <div/># UX/UI <div/>#                                                                                       | <div/># Selenium을 이용한 동적 크롤링 구현 <br/> # 카카오맵 api를 이용한 지도 시스템                                | <div/>#redis를 사용한 이메일 회원 인증                                                                      | <div/># 특별히 쓰고픈 점                                                                                          |
|                |                                                                                                             |                                                                                                             |                                                                                                                     |                                                                                                             |                                                                                                                   |
